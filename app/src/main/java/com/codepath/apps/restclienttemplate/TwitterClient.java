...
public class TwitterClient extends OAuthBaseClient {
	...
	public static final String REST_CONSUMER_KEY = "lejmy9WPBd2b5FTYGMcKgUWdD";       // Change this
	public static final String REST_CONSUMER_SECRET = "DLJLGRGFGIC5hJM4nabKAXWCWLplZkDib1ztcDTFqmkLtdMFF0"; // Change this
...
//		params.put("include_entities", true);
	...
	public void getInfHomeTimeline(long max_id, AsyncHttpResponseHandler handler) {
		String apiUrl = getApiUrl("statuses/home_timeline.json");
		// Can specify query string params directly or through RequestParams.
		RequestParams params = new RequestParams();
		params.put("count", 25);
...
//		params.put("include_entities", true);
	...
	public void getInfMentionsTimeline(long max_id, AsyncHttpResponseHandler handler) {
		String apiUrl = getApiUrl("statuses/mentions_timeline.json");
		// Can specify query string params directly or through RequestParams.
		RequestParams params = new RequestParams();
		params.put("count", 25);
...
//		params.put("include_entities", true);
	...
	public void getOtherUserTimeline(String screenName, AsyncHttpResponseHandler handler) {
		String apiUrl = getApiUrl("statuses/user_timeline.json");
		RequestParams params = new RequestParams();
		params.put("screen_name", screenName);
		params.put("count", 25);
	...
	public void sendTweet(String message, AsyncHttpResponseHandler handler) {
		...
		// can specific query string params directly or through RequestParams
		RequestParams params = new RequestParams();
